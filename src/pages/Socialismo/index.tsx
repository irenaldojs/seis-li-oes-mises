...
export default function Socialismo() {
  return (
    <ContainerComponent
      title="Socialismo"
      subtitle="Capítulo 2 – Segunda lição"
      text={`
...
direito de escolher sua guarnição, a praça onde servirá. Cabelhe cumprir ordens. E o sistema socialista – como o sabiam e
...
toda gente está feliz por comprar seus produtos.
 No sistema marxista, por outro lado, o corpo
governamental supremo deve primeiro ser convencido do valor
de uma ideia antes que ela possa ser levada adiante. Isso pode
ser algo muito difícil, uma vez que o grupo detentor do
comando – ou o ditador supremo em pessoa – tem o poder de
decidir. E se essas pessoas – por razões de indolência,
...
análise de todos os seus aspectos. Assim sendo, quero sugerirlhes, caso estejam interessados no problema básico de
...
Estes comitês, os líderes, os ditadores, são supremos; ao povo
cabe simplesmente obedecer-lhes.`}
    ></ContainerComponent>
  );
}
